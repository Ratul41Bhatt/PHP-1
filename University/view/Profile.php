		...
		<?php
			...
			if(isset($_POST['submit'])){
				...
				if($u_cover==''){
					...
					$update = "update admin set user_cover='$u_cover.$random_number' where user_id='$user_id'";
	...
	<?php
		if(isset($_POST['update'])){
				...
				if($u_image==''){
					...
					$update = "update admin set user_image='$u_image.$random_number' where user_id='$user_id'";
		...
		<?php
         ...
         if (isset($_GET['u_id'])) {
         	...
         	// code...
            	...
            	$get_posts="select user_email from admin where user_id='u_id'";
