...
include("../Model/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$check_email = "select * from admin where user_email='$email'";
		...
		$insert = "insert into admin (f_name,l_name,user_name,Relationship,user_pass,user_email,user_counrey,user_gender,user_birthday,user_image,user_cover,user_reg_date,posts,recovery_account)
